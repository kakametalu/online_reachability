...
import numpy as np
from mdp.mdp_base_reach_p_as_f import MDP_f
...
class GridWorld_f(MDP_f):
    ...
    Args:
        ...
        f_trans(function): Transition function
    ...
    def __init__(self, num_nodes, f_trans,  num_states,
                 num_actions, all_states=None,
        ...
        super().__init__(num_states, num_actions, gamma=gamma, f_trans=f_trans)
...
class ReachAvoid_f(GridWorld_f):
    ...
    def __init__(self, num_nodes, f_trans, num_states,
        ...
        super().__init__(num_nodes, f_trans, num_states, num_actions,
                         all_states, all_actions, gamma=gamma)
