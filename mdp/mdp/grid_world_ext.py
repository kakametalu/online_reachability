...
class Avoid(GridWorld):
    ...
    The value function corresponds to the maximum time to reach the avoid 
    set. Specifically the value function v(x) = 1 - exp(-T(x)), where T(x)
    is the maximum time to reach.
